...
-----------------------------------------------------------------------------------------------------
   ...
   ["sttttt"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "sttttt", AnimationOptions =
   {
       Prop = 'jendrik_prop_calendar002',
       PropBone = 24817,
       PropPlacement = {-0.07, 0.46, -0.016, -180.0, 0.0, 22.0},
       EmoteMoving = true,
       EmoteLoop = true
   }},
   ["icrrrrr"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "icrrrrr", AnimationOptions =
   {
       Prop = 'jendrik_prop_calendar001',
       PropBone = 24817,
       PropPlacement = {-0.07, 0.46, -0.016, -180.0, 0.0, 22.0},
       EmoteMoving = true,
       EmoteLoop = true

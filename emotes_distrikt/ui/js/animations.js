...
const XMenu = {
    ...
    <div class="animation__main">
        <p class="main__header">Animationen</p>
        ...
        <div class="quick__block">
            <p class="quick__title">SCHNELLZUGRIFF</p>
            <p class="quick__subtitle">Zum Hinzufügen von Emotes zum Schnellzugriff - klicke und ziehe einfach ein Emote hier her.</p>
            <div class="quick__menu">
                <div class="menu__cell" v-for="i in 6" :data-slot="i">
                    <div class="anim__slot" :class="{free:isFree(i),drag:isDragging}" @click="translate(i)">
    ...
    methods:{
        ...
        getFastTitle(i){
            localStorage.setItem('getFastTitle', this.fastSlots[i].length && this.fastSlots[i][0] && (this.fastSlots[i][0]).category && (this.fastSlots[i][0]).category.name?(this.fastSlots[i][0]).category.name:'')
            return (localStorage.getItem('getFastTitle'))
        },
        getSubTitle(i){
            localStorage.setItem('getSubTitle', this.fastSlots[i].length && this.fastSlots[i][0] && (this.fastSlots[i][0]).name?(this.fastSlots[i][0]).name:'');
            return (localStorage.getItem('getSubTitle'))
        },
        isFree(i){
            localStorage.setItem('isFree', this.fastSlots[i].length);
            return (localStorage.getItem('isFree')===0)?true:false;
        },
        translate(i){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: this.fastSlots[i][0].ad, an: this.fastSlots[i][0].an, wl: this.fastSlots[i][0].wl, useprop: this.fastSlots[i][0].useprop,propname: this.fastSlots[i][0].propname, propbones: this.fastSlots[i][0].propbones, propoffsetX: this.fastSlots[i][0].propoffsetX, propoffsetY: this.fastSlots[i][0].propoffsetY, propoffsetZ: this.fastSlots[i][0].propoffsetZ, proprotX: this.fastSlots[i][0].proprotX, proprotY: this.fastSlots[i][0].proprotY, proprotZ: this.fastSlots[i][0].proprotZ}));
            // localStorage.setItem('ad', this.fastSlots[i][0].ad);
            // localStorage.setItem('an', this.fastSlots[i][0].an);
        },
    },
    watch:{
...
const animations = new Vue({
    ...
    methods:{
        ...
        exit: function(){
			$.post('https://emotes_distrikt/bur_exit_anim', JSON.stringify({}));
            this.isActive = false
		},
        open: function(){
			this.isActive = true
        ...
        b1: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad1'), an: localStorage.getItem('an1')}));
            window.localStorage.setItem('ad1', this.fastSlots[1][0].ad);
            window.localStorage.setItem('an1', this.fastSlots[1][0].an); 
        },
        b2: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad2'), an: localStorage.getItem('an2')}));
            window.localStorage.setItem('ad2', this.fastSlots[2][0].ad);
            window.localStorage.setItem('an2', this.fastSlots[2][0].an); 
        },
        b3: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad3'), an: localStorage.getItem('an3')}));
            window.localStorage.setItem('ad3', this.fastSlots[3][0].ad);
            window.localStorage.setItem('an3', this.fastSlots[3][0].an); 
        },
        b4: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad4'), an: localStorage.getItem('an4')}));
            window.localStorage.setItem('ad4', this.fastSlots[4][0].ad);
            window.localStorage.setItem('an4', this.fastSlots[4][0].an); 
        },
        b5: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad5'), an: localStorage.getItem('an5')}));
            window.localStorage.setItem('ad5', this.fastSlots[5][0].ad);
            window.localStorage.setItem('an5', this.fastSlots[5][0].an); 
        },
        b6: function(){
            $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: localStorage.getItem('ad6'), an: localStorage.getItem('an6')}));
            window.localStorage.setItem('ad6', this.fastSlots[6][0].ad);
            window.localStorage.setItem('an6', this.fastSlots[6][0].an); 
        },
        playAnim(animation,isSpecial){
            if(isSpecial){
                this.walkStyle = animation.style;
                $.post('https://emotes_distrikt/bur_nui_walk_start', JSON.stringify({style: animation.style}));
            }else{
                $.post('https://emotes_distrikt/bur_nui_anim_start', JSON.stringify({ad: animation.ad, an: animation.an, wl: animation.wl, useprop: animation.useprop,propname: animation.propname, propbones: animation.propbones, propoffsetX: animation.propoffsetX, propoffsetY: animation.propoffsetY, propoffsetZ: animation.propoffsetZ, proprotX: animation.proprotX, proprotY: animation.proprotY, proprotZ: animation.proprotZ}));
            }
        }
    },
})
